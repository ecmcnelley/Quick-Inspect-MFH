...
/* -------------------------------------------
   Presentational components (TOP-LEVEL!)
   Defining these outside keeps identity stable,
   so inputs don't remount on every keystroke.
------------------------------------------- */
...
const Step3 = memo(function Step3({ goToPrevStep, goToNextStep }) {
  return (
    <section className="card">
...
/* -------------------------------------------
   Main App (now only passes stable props)
------------------------------------------- */
